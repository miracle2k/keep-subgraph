...
export class TBTCTokenContract extends ethereum.SmartContract {
  static bind(address: Address): TBTCTokenContract {
    return new TBTCTokenContract("TBTCTokenContract", address);
  }
