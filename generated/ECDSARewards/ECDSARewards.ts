...
export class ECDSARewards extends ethereum.SmartContract {
  static bind(address: Address): ECDSARewards {
    return new ECDSARewards("ECDSARewards", address);
  }

  beneficiaryRewardCap(): BigInt {
    let result = super.call(
      "beneficiaryRewardCap",
      "beneficiaryRewardCap():(uint256)",
      []
    );
  ...
  try_beneficiaryRewardCap(): ethereum.CallResult<BigInt> {
  ...
  getAllocatedRewards(interval: BigInt, operator: Address): BigInt {
    let result = super.call(
      "getAllocatedRewards",
      "getAllocatedRewards(uint256,address):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(interval),
  ...
  getAllocatedRewards1(interval: BigInt): BigInt {
    let result = super.call(
      "getAllocatedRewards",
  ...
  try_getAllocatedRewards1(interval: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getAllocatedRewards",
      "getAllocatedRewards(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(interval)]
  ...
  getWithdrawableRewards(interval: BigInt, operator: Address): BigInt {
    let result = super.call(
      "getWithdrawableRewards",
      "getWithdrawableRewards(uint256,address):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(interval),
        ethereum.Value.fromAddress(operator)
      ]
  ...
  getWithdrawnRewards(interval: BigInt, operator: Address): BigInt {
    let result = super.call(
      "getWithdrawnRewards",
      "getWithdrawnRewards(uint256,address):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(interval),
        ethereum.Value.fromAddress(operator)
      ]
...
export class ConstructorCall__Inputs {
  ...
  get _tokenStakingAddress(): Address {
